...
module.exports = {
	...
	async execute(member) {
		...
		const queryText = `
			INSERT INTO users (discord_id, username, discriminator, join_date, rank, points, left_at)
			VALUES ($1, $2, $3, $4, $5, $6, NULL)
			ON CONFLICT (discord_id) DO 
			UPDATE SET username = $2, discriminator = $3, join_date = $4, rank = $5, points = $6, left_at = NULL;
		`;

		try {
			await db.query(queryText, [id, username, discriminator, join_date, 0, 0]);
